...
import './CustomerLogin.module.css';
...
export default function CustomerLogin({ onCustomerLogin }) {
      ...
      <MDBContainer className="my-5">
        <MDBCard>
          <MDBRow className='g-0'>
            <MDBCol md='6'>
              <MDBCardImage src='https://media.licdn.com/dms/image/D5612AQEF_Vv3rPOofg/article-cover_image-shrink_720_1280/0/1706898205827?e=1716422400&v=beta&t=paix_b5OiDu4YjP0kaxOX4RfWRKAMafzB5l-YY44uZg' alt="login form" className='rounded-start w-100' />
            </MDBCol>
            <MDBCol md='6'>
  ...
  <MDBBtn className="mb-4 px-5" color='danger' size='lg' type="submit">Login</MDBBtn>
    ...
    Don't have an account? <a href="/customerregistration" style={{ color: '#393f81', textDecoration: 'underline' }}>Register here</a>
  </div>                         </div>
                <div className='text-center'>
