...
export default function MainNavBar({ onAdminLogin,onCustomerLogin,onRestaurantOwnerLogin }) {
  ...
  return (
    <div>
    <Navbar expand="lg" className="bg-orange navbar-custom sticky-top"> <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          <Nav className="mx-auto"> 
            <Nav.Link href="/home" className="nav-link-large"><BsFillHouseFill /> Home</Nav.Link>
            <Nav.Link href="#how" className="nav-link-large"><BsBarChartSteps /> How It Works</Nav.Link>
            <Nav.Link href="#about" className="nav-link-large"><BsFillInfoSquareFill /> About</Nav.Link>
            <Nav.Link href="#faq" className="nav-link-large"><BsQuestionSquareFill /> FAQ</Nav.Link>
          </Nav>
          <NavDropdown 
            title="Login" 
            ...
            onMouseLeave={toggleLoginDropdown} 
